...
namespace WebGym.Migrations
{
    ...
    [Migration("20240515190619_MigrationGetPaymentRemoveCreatedAt")]
    partial class MigrationGetPaymentRemoveCreatedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gym.Model.Amount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Gym.Model.Amount", b =>
                {
                    b.HasOne("Gym.Model.Order", "Order")
                        .WithOne("Amount")
                        .HasForeignKey("Gym.Model.Amount", "OrderId")
